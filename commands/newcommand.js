...
exports.execute = function(bot, msg, suffix){
  return new Promise((resolve, reject) => {${execCode}
  });
}`;
}
...
exports.execute = function(bot, msg, suffix){
  return new Promise((resolve, reject) => {
    ...
    bot.Utils.createFile(`commands/${command_name}.js`, code)
      .then(() => {
        bot.Utils.updateCommandList().then(resolve).catch(reject.bind(undefined, "Update command list failed"));
      }).catch(reject.bind(undefined, "Create file failed"));
  });
}